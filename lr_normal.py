...
def lr_model_alog(mydata, file_ext):
    print("lr_model_alog Normal Mode Running.....!")
    print(mydata.head())
    if file_ext == ".txt":
    ...
    lr_model_final = lr_model  # for user input
    ...
    return result, imgpath_html, Mean_Absolute_Error, Mean_Squared_Error, Root_Mean_Squared_Error, score, lr_model_final