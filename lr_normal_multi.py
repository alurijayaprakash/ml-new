def sample():
    return "Hello Normal Mode Running.....!"
import os
import numpy as np
import pandas as pd
...
def lr_normal_multi(mydata, file_ext):
    print("lr_normal_multi Normal Mode Running.....!")
    print(mydata.head())
    ...
    lr_model_multi_final = lr_model  # for user input
    ...
    return result, imgpath_html, Mean_Absolute_Error, Mean_Squared_Error, Root_Mean_Squared_Error, score, lr_model_multi_final
